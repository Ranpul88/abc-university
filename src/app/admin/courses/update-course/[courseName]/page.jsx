...
export default function UpdateCourse() {
    ...
    useEffect(() => {
        ...
        .then((data) => {
            ...
            setEntryRequirements(data.entryRequirements.join(','))
    ...
    async function updateCourse(){
        ...
        for(let i = 0; i < newFiles.length; i++){
            const promises = uploadFile(newFiles[i])
        ...
        body: JSON.stringify({
            ...
            courseContent: courseContent.length > 0 ? courseContent : files,
    ...
    return (
        <div className="w-full h-full flex items-center justify-center">
            ...
            <div className="flex flex-col">
                ...
                <input type="text" disabled={true} value={course} className="border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-accent" />
            </div>
            ...
            <div className="flex flex-col">
                ...
                <input type="file" multiple={true}  onChange={(e) => {setNewFiles(e.target.files), setDisabled(false)}} className="border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-accent cursor-pointer" />
            </div>
