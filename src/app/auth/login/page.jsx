  ...
  return (
    <div className='w-full h-[calc(100%-100px)] flex justify-center items-center '>
      {isLoading ? <Loader /> : <div className='w-82 h-100 border-3 rounded-3xl p-4 flex flex-col items-center'>
        ...
        <p className='w-[90%] text-right text-[13px] mb-8 mr-1'>Forgot password? <Link href='/auth/forgot-password' className='italic lg:text-secondary text-accent hover:text-accent'>Reset here</Link></p>
